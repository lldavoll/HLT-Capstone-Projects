# Data
**NPSpecies**: This dataset explores the species at the most visited National Parks in the USA. NPSpecies contains species listed by National Parks maintained by National Parks Service (NPS). Given the size of the dataset, we're focusing on the 15 most visited parks. The data comes from https://irma.nps.gov/NPSpecies/Search/SpeciesList.

For a more detailed information on the dataset, here is the glossary for column names, field options, and tag meanings: https://irma.nps.gov/content/npspecies/Help/docs/NPSpecies_User_Guide.pdf

*This data was accessed on March 5th, 2025.*

Citation:

**NPSpecies - The National Park Service biodiversity database.**
**https://irma.nps.gov/npspecies/. March 5th, 2025/11:00 a.m.**
# Codebook for NPSpecies Dataset
